...
function Solution() {
  const steps = [
    { n: "01", title: "Discovery Call", desc: "Tell us your goals, brand, and use cases." },
    {
      ...
      desc: "We gather your reference videos, photos, and voice samples.",
    },
    {
      n: "03",
      title: "Clone Building",
      desc: "Our team trains voice, generates avatar, produces variations.",
    },
    {
      n: "04",
      title: "Quality Review",
      desc: "Internal QA + your preview with unlimited revisions.",
    },
    {
      n: "05",
      title: "Delivery",
      desc: "Final files in all formats. Ready to deploy everywhere.",
    },
  ];
  return (
    <section
    ...
    >
      <FadeIn>
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          >
            Easy Clones is a done-for-you AI clone service. No courses. No DIY tools. No
...
function Results() {
  const testimonials = [
    {
      quote:
        "Rafael and his team built our AI clone system that powers our entire content operation. The quality is indistinguishable from real footage and the turnaround is unbelievable.",
    ...
    {
      quote:
        "We needed high-volume content across multiple channels without slowing down our marketing. Easy Clones delivered exactly that — fast, professional, and scalable.",
      name: "Adam Godrosi",
    ...
    {
      quote:
        "At our scale, content production was one of our biggest bottlenecks. Easy Clones cut our content costs dramatically while increasing our output tenfold.",
      name: "Nick Daniels",
      role: "CEO, VShred",
      initials: "ND",
    },
    {
      quote:
        "As someone who needs to be everywhere at once — podcasts, social, ads — having a clone that looks and sounds like me has been a complete game-changer for my brand.",
      name: "Mark Moss",
  ...
  const segments = [
    {
      ...
      desc: "Scale content 10x without filming daily",
    },
    {
      icon: "\uD83D\uDED2",
      title: "E-Commerce Sellers",
      desc: "AI clone presents products 24/7 in multiple languages",
    },
    {
      icon: "\uD83C\uDF93",
      title: "Coaches & Brands",
      desc: "Clone delivers ads, testimonials, and course previews",
    },
    {
      icon: "\uD83C\uDFE2",
      title: "Agencies",
      desc: "White-label clone creation for your own clients",
    },
  ];
  return (
    <section
...
function FAQ() {
  ...
  const faqs = [
    [
      ...
      "It\u2019s a digital version of a person — their face, voice, and mannerisms — powered by AI. It can speak, present products, and create content autonomously.",
    ],
    [
      "Do I need to be on camera?",
      "We\u2019ll need some reference footage or photos to build the clone, but after that, your clone does the work — you don\u2019t need to film again.",
    ],
    [
      "How long does it take?",
      "Standard delivery is 5\u20137 business days. Rush delivery (48 hours) is available for an additional fee.",
    ],
    [
      "Can my clone speak other languages?",
      "Yes! Multi-language clones are available. Your clone can present in English, Spanish, Portuguese, French, Arabic, and more.",
    ],
    [
      "Is this legal?",
      "Absolutely. We only create clones with the full written consent of the person being cloned. Our terms of service ensure ethical use.",
    ],
    [
      "What if I\u2019m not happy with the result?",
      "Every package includes revision rounds. We work with you until you\u2019re satisfied.",
    ],
    [
      "How is this different from HeyGen or Synthesia?",
      "Those are DIY tools — you still have to figure everything out yourself. Easy Clones is a done-for-you service. We handle all the technical work and deliver production-ready content.",
    ],
  ];
  return (
    <section
      id="faq"
      style={{
        padding: "100px max(24px, calc((100% - 750px)/2))",
        background: LIGHT_GRAY,
      }}
    >
      <FadeIn>
...
function FinalCTA() {
  return (
    <section
      id="book"
      style={{
        padding: "100px max(24px, calc((100% - 900px)/2))",
        background: "white",
      }}
    >
      <div
        ...
        <FadeIn delay={0.15}>
          ...
          >
            ...
            >
              ...
              >
                Embed your Jotform here by replacing the placeholder in the code with your
                form&apos;s iframe URL.
              </div>
              <div
                style={{
